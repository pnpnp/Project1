...
<link href="web/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" /><!-- bootstrap-css -->

<link href="web/css/owl.carousel.css" rel="stylesheet"><!-- Owl-carousel-CSS -->

<link href="web/css/popup-box.css" rel="stylesheet" type="text/css" media="all" /><!-- pop-up css --> 

<link href="web/css/style.css" rel="stylesheet" type="text/css" media="all" />

<!-- banner css -->
<link rel="stylesheet" href="web/css/poposlides.css" type="text/css" media="all" />
<!-- //banner css -->
...
<div class="demo-inner-content" id="home">
	...
	<!-- header -->
			...
			<nav class="navbar navbar-default navbar-fixed-top"> 
				<div class="container">
					<div class="navbar-header page-scroll">
						...
						<h1><a class="navbar-brand" href="index.html">Tourist</a></h1>
					</div> 
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav navbar-right cl-effect-15">
							...
							<li><a class="page-scroll scroll" href="Login">Login/SignUp</a></li>
						</ul>
					</div>
					<!-- /.navbar-collapse -->
				</div>
		...
		<div class="slides-box">
			<ul class="slides">
				<li style="background: url(web/images/s1.jpg) no-repeat;background-size:cover;"></li>
				<li style="background: url(web/images/s2.jpg) no-repeat;background-size:cover;"></li>
				<li style="background: url(web/images/s3.jpg) no-repeat;background-size:cover;"></li>
				<li style="background: url(web/images/s4.jpg) no-repeat;background-size:cover;"></li>
				<li style="background: url(web/images/s5.jpg) no-repeat;background-size:cover;"></li>
			</ul>
		</div>
		<!-- //banner  -->
	</div>
	...
	<div class="container">  
		<div class="w3ls-title"> 
			...
			<div class="col-md-4 middle-img">
				<img src="web/images/package1.jpg" alt="about image" />
			</div>
	...
	<div class="container">
		...
		<div class="packages_grids">
			<div class="packages_grid1">
				...
				<div class="col-md-3 package1">
					<img src="web/images/package2.jpg" alt="package1" />
					<h4>Paris Eiffel Tower</h4>
					<h5>290$</h5>
					<a href="#small-dialog" class="w3_agileits_sign_up2 popup-with-zoom-anim ab scroll">Book Now</a>
				</div>
				<div class="col-md-6 package1">
					<img src="web/images/package3.jpg" alt="package1" />
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="packages_grid2">
				<div class="col-md-6 package1">
					<img src="web/images/package6.jpg" alt="package1" />
				</div>
				<div class="col-md-3 package1">
					<img src="web/images/package4.jpg" alt="package1" />
					<h4>Thailand Summer Beach</h4>
					<h5>850$</h5>
					<a href="#small-dialog" class="w3_agileits_sign_up2 popup-with-zoom-anim ab scroll">Book Now</a>
				</div>
				<div class="col-md-3 package1">
					<img src="web/images/package5.jpg" alt="package1" />
					...
					<div id="owl-demo2" class="owl-carousel">
							...
							<div class="test-grid">
								<div class="test-grid1">
									<div class="test-grid2">
										<img src="web/images/1.jpg" alt="" class="img-r">
									</div>
						...
						<div class="agile">
							<div class="test-grid">
								<div class="test-grid1">
									<div class="test-grid2">
										<img src="web/images/2.jpg" alt="" class="img-r">
									</div>
									<div class="test-grid2_text">
										<h4>Steve Warner</h4>
									</div>
						...
						<div class="agile">
							<div class="test-grid">
								<div class="test-grid1">
									<div class="test-grid2">
										<img src="web/images/3.jpg" alt="" class="img-r">
									</div>
									<div class="test-grid2_text">
										<h4>James Warner</h4>
									</div>
...
<script src="web/js/counterup.min.js"></script> 
<script>
...
<!-- for banner js file-->
<script src="web/js/poposlides.js"></script>
	<script>
		$(".slides").poposlides();
	</script>
<!-- //for banner js file-->
